    ...
    >
      ...
      <TriangleCorner
          style={{
            ...
            borderTopWidth: 38,
            borderRightWidth: 38,
            borderTopColor: Colors.global.orange800,
          }}
        />
        <View className="bg-orange-800 flex-1 flex-row items-center justify-center pt-2">
      ...
      <View className="bg-orange-800 mx-2">
        ...
        {character?.data.skills.slice(11, 18).map((skill, index) => (
          <SkillItem
            key={index}
            index={index}
            skill={skill}
      ...
      <TriangleCorner
        ...
        />
        <View className="bg-orange-800 flex-1 flex-row items-center justify-start pl-2"/>
        <TriangleCorner
          style={{
