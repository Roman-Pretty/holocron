            ...
            <View className='w-full my-[2vh]'>
                <View className='flex-row items-start'>
                    ...
                    <TriangleCorner style={{
                        ...
                        borderTopWidth: '24px', borderRightWidth: '24px', borderTopColor: Colors.global.box,
                    }} />
                </View>
                <View className='bg-box p-3'>
                    <View className='flex flex-row items-center justify-start'>
                        <View className={`w-[28vw] h-[28vw] overflow-hidden rounded-full bg-white border-2 ${selectedSpecies === species ? 'border-statblockbackground' : 'border-box'}`}>
                            <Image
                        ...
                        <View>
                            ...
                            <Text className='text-sm text-boxheading pl-[4vw] max-w-[56vw]'>{species.desc}</Text>
                        </View>
                    </View>
                    ...
                    <View className='mt-[2vh] flex-row items-start justify-between'>
                        <View className='flex-row items-center'>
                            ...
                            <Text className='text-white text-sm pl-1'><Text className=' font-bold'>WT:</Text> {species.woundThreshold} + Br</Text>
                        </View>
                        <View className='flex-row items-center'>
                            <Ionicons size={16} name='flash-outline' color="white" />
                            <Text className='text-white text-sm pl-1'><Text className=' font-bold'>ST:</Text> {species.strainThreshold} + Wil</Text>
                        </View>
                        <View className='flex-row items-center'>
                    ...
                    <View className='mt-[2vh] flex-row items-start'>
                        ...
                        <Text className='text-white text-sm pl-2 max-w-[80vw]'>{species.speciesBonus}</Text>
                    </View>
                    ...
                    {selectedSpecies && selectedSpecies.species === species.species ?
                        <Button title={`Selected ${species.species}`} disabled className='mt-[3vh] border-statblockbackground bg-white border-2' /> :
                        <Button title={`Select ${species.species}`} onPress={() => handleSelect()} className='mt-[3vh] bg-statblockbackground' />}
                </View>
            </View>
