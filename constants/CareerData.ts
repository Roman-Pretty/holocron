    ...
    specializations: [
      {
        ...
        talents: {
          talents: [
            ...
            {
              talent: TalentData.BEAST_WRANGLER,
              cost: 5,
            ...
            {
              talent: TalentData.EXPERT_TRACKER,
              cost: 10,
            ...
            {
              talent: TalentData.EXPERT_HANDLER,
              cost: 10,
            ...
            {
              talent: TalentData.SPUR_IMPROVED,
              cost: 20,
            ...
            {
              talent: TalentData.NATURAL_OUTDOORSMAN,
              cost: 20,
            ...
            {
              talent: TalentData.SPUR_SUPREME,
              cost: 25,
            ...
            {
              talent: TalentData.SOOTHING_TONE,
              cost: 25,
